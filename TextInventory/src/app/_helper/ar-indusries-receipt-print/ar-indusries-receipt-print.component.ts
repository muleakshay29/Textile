...
@Component({
  selector: "app-ar-indusries-receipt-print",
  templateUrl: "./ar-indusries-receipt-print.component.html",
  styleUrls: ["./ar-indusries-receipt-print.component.css"],
})
export class ArIndusriesReceiptPrintComponent implements OnInit {
  content = [];
