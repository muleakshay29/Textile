...
export class QualityMasterComponent implements OnInit {
  ...
  getItemCount() {
    this.spinner.show();
    this.cmservice.getItemCount("quality-count").subscribe((count) => {
  ...
  deleteQuality(_id) {
    this.cmservice.deleteData(_id, "delete-quality").subscribe((result) => {
      if (result != null) {
        this.deleteQualityWarf(_id);
        this.deleteQualityWeft(_id);
  ...
  deleteQualityWarf(_id) {
    this.cmservice.deleteData(_id, "delete-quality-warf").subscribe();
  }

  deleteQualityWeft(_id) {
    this.cmservice.deleteData(_id, "delete-quality-weft").subscribe();
  }
